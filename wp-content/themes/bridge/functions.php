...
function draft_daddy_custom_styles() {
	wp_enqueue_style("custom-inputs", QODE_ROOT . "/css/custom-inputs.css");
	wp_enqueue_style("custom-styles", QODE_ROOT . "/css/custom-styles.css");
	wp_enqueue_script( 'classie', QODE_ROOT . '/js/classie.js', array(),false,true);
}
add_action( 'wp_enqueue_scripts', 'draft_daddy_custom_styles' );
